...
URS0201 = Class(CSeaUnit) {
    ...
    TransformThread = function(self, land)
        ...
        if( land ) then
            ...
            self:SetCollisionShape( 'Box', bp.CollisionOffsetX or 0, bp.SizeY * 0.5, bp.CollisionOffsetZ or 0, bp.SizeX * scale, bp.SizeY * scale, bp.SizeZ * scale )
            ...
            self.IsWaiting = true
            WaitFor(self.AnimManip)
            self:SetCollisionShape( 'Box', bp.CollisionOffsetX or 0, bp.CollisionOffsetY or 0, bp.CollisionOffsetZ or 0, bp.SizeX * scale, bp.SizeY * scale, bp.SizeZ * scale )
            self.IsWaiting = false
